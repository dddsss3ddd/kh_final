                ...
                <div class="col-sm-6">
                    <div class="project-name overflow">
                        ...
                        <ul class="nav navbar-nav navbar-default">
                            <li><a href="jsp/main/#"><i class="fa fa-clock-o"></i>February11,2014</a></li>
                            <li><a href="jsp/main/#"><i class="fa fa-tag"></i>Branding</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="skills overflow">
                        <h3>Skills:</h3>
                        <ul class="nav navbar-nav navbar-default">
                            <li><a href="jsp/main/#"><i class="fa fa-check-square"></i>Design</a></li>
                            <li><a href="jsp/main/#"><i class="fa fa-check-square"></i>HTML/CSS</a></li>
                            <li><a href="jsp/main/#"><i class="fa fa-check-square"></i>Javascript</a></li>
                            <li><a href="jsp/main/#"><i class="fa fa-check-square"></i>Backend</a></li>
                        </ul>
                    </div>
                    <div class="client overflow">
                        <h3>Client:</h3>
                        <ul class="nav navbar-nav navbar-default">
                            <li><a href="jsp/main/#"><i class="fa fa-bolt"></i>Okler Themes</a></li>
                        </ul>
                    </div>
                    <div class="live-preview">
                        <a href="jsp/main/#" class="btn btn-common uppercase">Live preview</a>
                    </div>
                </div>
            </div>
        </div>
