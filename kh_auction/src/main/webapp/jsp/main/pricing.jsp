            ...
            <div class="row">
                <div class="col-sm-6 col-md-3">
                    <div class="single-price">
                        ...
                        <a href="jsp/main/#" class="btn btn-buynow">Buy Now</a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3">
                    <div class="single-price highligh-table">
                        ...
                        <a href="jsp/main/#" class="btn btn-buynow btn-hightlight">Buy Now</a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3">
                    <div class="single-price">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-3">                    
                    <div class="single-table">
                        ...
                        <span class="btn-signup"><a href="jsp/main/#">sign up</a></span>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3">
