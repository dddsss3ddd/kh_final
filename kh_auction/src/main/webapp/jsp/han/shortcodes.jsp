                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <ul id="tab1" class="nav nav-tabs">
                            <li class="active"><a href="jsp/main/#tab1-item1" data-toggle="tab">Tab 1</a></li>
                            <li><a href="jsp/main/#tab1-item2" data-toggle="tab">Tab 2</a></li>
                            <li><a href="jsp/main/#tab1-item3" data-toggle="tab">Tab 3</a></li>
                        </ul>
                    ...
                    <div class="col-md-6">
                        <ul id="tab2" class="nav nav-pills">
                            <li class="active"><a href="jsp/main/#tab2-item1" data-toggle="tab">Tab 1</a></li>
                            <li><a href="jsp/main/#tab2-item2" data-toggle="tab">Tab 2</a></li>
                            <li><a href="jsp/main/#tab2-item3" data-toggle="tab">Tab 3</a></li>
                        </ul>
                        <div class="tab-content">
