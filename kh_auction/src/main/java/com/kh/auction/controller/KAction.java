...
import com.kh.auction.dao.KService;
...
public class KAction {
	...
	//예시 메서드 입니다.
	@RequestMapping(value="bbs_was3gsdrite.nhn")
	public String bbs_write() {
		return "bbs/bbs_write"; //bbs 폴더의 bbs_write.jsp 뷰
	}
	
	//예시 메서드 입니다.
	@RequestMapping(value="/bbs_wrig43gsdgte_ok.nhn",method=RequestMethod.POST)
	public String bbs_write_ok(BbsBean_sample bbsbean) throws Exception{
		...
		this.kService.insertBbs(bbsbean); //저장 메서드 호출
	...
	@RequestMapping(value="minho_in.kk")
	public String gosgos (	) throws Exception {
		return "kim/test";
	}
	
	@RequestMapping(value="minho.kk")
	public String testin (
			KBean kb
			) throws Exception {
		kService.testIn(kb);
		System.out.println(kb.getKval1()+kb.getKval2());
		return "redirect:haech_in.jj";
	}
